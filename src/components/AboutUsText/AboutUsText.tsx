    ...
    return (
        <div className={scss.title_block}>
            ...
            <div className={scss.text}>
                ...
                <div className={scss.paragraph}> Our simple and efficient camps are comfortable, and wholesome camp meals are as filling as delicious. Our itineraries are as varied as our clients. Rigorous mountain expeditions, serene lake paddling, wildlife photography, whitewater rafting… We are always thinking of fun new trips and new ways to experience one of the largest wilderness areas on earth.</div>
                <div className={scss.paragraph}>
                In addition to our regular schedule of trips. We also take families, clubs and groups of friends on custom trips each summer. Whatever your dream trip is, and no matter what size group you have in mind we are happy to work with you to help you plan and enjoy a memorable and safe guided adventure.
                </div>
                <div className={scss.paragraph}>
